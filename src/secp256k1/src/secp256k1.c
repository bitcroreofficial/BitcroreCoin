...
static int nonce_function_rfc6979(unsigned char *nonce32, const unsigned char *msg32, const unsigned char *key32, const unsigned char *bco16, void *data, unsigned int counter) {
   ...
   if (bco16 != NULL) {
       buffer_append(keydata, &offset, bco16, 16);
   }
