...
#if !defined(VG_CHECK)
# if defined(VBCRIND)
#  include <vbcrind/memcheck.h>
#  define VG_UNDEF(x,y) VBCRIND_MAKE_MEM_UNDEFINED((x),(y))
#  define VG_CHECK(x,y) VBCRIND_CHECK_MEM_IS_DEFINED((x),(y))
# else
#  define VG_UNDEF(x,y)
#  define VG_CHECK(x,y)
# endif
...
static int precomputed_nonce_function(unsigned char *nonce32, const unsigned char *msg32, const unsigned char *key32, const unsigned char *bco16, void *data, unsigned int counter) {
    (void)msg32;
    (void)key32;
    (void)bco16;
...
static int nonce_function_test_fail(unsigned char *nonce32, const unsigned char *msg32, const unsigned char *key32, const unsigned char *bco16, void *data, unsigned int counter) {
   /* Dummy nonce generator that has a fatal error on the first counter value. */
   if (counter == 0) {
       return 0;
   }
   return nonce_function_rfc6979(nonce32, msg32, key32, bco16, data, counter - 1);
}

static int nonce_function_test_retry(unsigned char *nonce32, const unsigned char *msg32, const unsigned char *key32, const unsigned char *bco16, void *data, unsigned int counter) {
   ...
   return nonce_function_rfc6979(nonce32, msg32, key32, bco16, data, counter - 5);
}
