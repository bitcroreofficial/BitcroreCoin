...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Bitcrore Coin bitcrore_coin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitcrore_coin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcrore_coin transaction") + "\n" +
                               "  bitcrore_coin-tx [options] -create [commands]   " + _("Create hex-encoded bitcrore_coin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcrore_coin transaction
