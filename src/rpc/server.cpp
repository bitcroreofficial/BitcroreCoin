...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop Bitcrore_Coin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Bitcrore Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Bitcrore_Coin features */
        {"bitcrore_coin", "listmasternodes", &listmasternodes, true, true, false},
        {"bitcrore_coin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitcrore_coin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"bitcrore_coin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"bitcrore_coin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"bitcrore_coin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitcrore_coin", "masternodedebug", &masternodedebug, true, true, false},
        {"bitcrore_coin", "startmasternode", &startmasternode, true, true, false},
        {"bitcrore_coin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitcrore_coin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitcrore_coin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitcrore_coin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitcrore_coin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitcrore_coin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitcrore_coin", "preparebudget", &preparebudget, true, true, false},
        {"bitcrore_coin", "submitbudget", &submitbudget, true, true, false},
        {"bitcrore_coin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitcrore_coin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitcrore_coin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitcrore_coin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitcrore_coin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitcrore_coin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitcrore_coin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitcrore_coin", "checkbudgets", &checkbudgets, true, true, false},
        {"bitcrore_coin", "mnsync", &mnsync, true, true, false},
        {"bitcrore_coin", "spork", &spork, true, true, false},
...
{
    return "> bitcrore_coin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:1671/\n";
}
