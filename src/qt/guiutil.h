...
/** Utility functions used by the Bitcrore_Coin Qt UI.
 */
namespace GUIUtil
{
...
// Render Bitcrore_Coin addresses in monospace font
...
// Parse "bitcrore_coin:" URI into recipient object, return true on successful parsing
