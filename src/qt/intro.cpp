...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Bitcrore Coin"),
     ...
     * override -datadir in the bitcrore_coin.conf file in the default data directory
     * (to be consistent with bitcrore_coind behavior)
     */
