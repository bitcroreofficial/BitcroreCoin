...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            Bitcrore_CoinGUI* window = static_cast<Bitcrore_CoinGUI*>(parentWidget());
...
{
    Bitcrore_CoinGUI* gui = static_cast<Bitcrore_CoinGUI*>(parentWidget());
...
{
    hide();
    static_cast<Bitcrore_CoinGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Bitcrore_Coin will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your BCs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
