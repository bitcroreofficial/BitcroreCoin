...
/** Interface from Qt to configuration data structure for Bitcrore_Coin client.
...
public:
    ...
    enum OptionID {
        ...
        HideOrphans,    // bool
        AnonymizeBitcrore_CoinAmount, //int
...
Q_SIGNALS:
    ...
    void anonymizeBitcrore_CoinAmountChanged(int);
