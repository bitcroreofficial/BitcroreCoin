...
#include "qt/bitcrore_coin/forms/ui_addresseswidget.h"
#include "qt/bitcrore_coin/addresslabelrow.h"
#include "qt/bitcrore_coin/addnewaddressdialog.h"
#include "qt/bitcrore_coin/tooltipmenu.h"
...
AddressesWidget::AddressesWidget(Bitcrore_CoinGUI* parent) :
    PWidget(parent),
...
void AddressesWidget::onStoreContactClicked()
{
    if (walletModel) {
        ...
        CTxDestination bcAdd = DecodeDestination(address.toUtf8().constData(), isStakingAddress);
        ...
        if (walletModel->updateAddressBookLabels(bcAdd, label.toUtf8().constData(),
