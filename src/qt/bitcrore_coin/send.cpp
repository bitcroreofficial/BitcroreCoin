...
#include "qt/bitcrore_coin/forms/ui_send.h"
#include "qt/bitcrore_coin/addnewcontactdialog.h"
#include "qt/bitcrore_coin/qtutils.h"
#include "qt/bitcrore_coin/sendchangeaddressdialog.h"
#include "qt/bitcrore_coin/optionbutton.h"
#include "qt/bitcrore_coin/sendconfirmdialog.h"
#include "qt/bitcrore_coin/myaddressrow.h"
#include "qt/bitcrore_coin/guitransactionsutils.h"
...
SendWidget::SendWidget(Bitcrore_CoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::send),
    ...
    btnContacts(new QPushButton())
{
    ...
    setCssProperty(coinIcon, "coin-icon-bc");
...
void SendWidget::onContactMultiClicked()
{
    if (focusedEntry) {
        ...
        CTxDestination bcAdd = DecodeDestination(address.toStdString());
        if (walletModel->isMine(bcAdd)) {
        ...
        if (dialog->res) {
            ...
            if (walletModel->updateAddressBookLabels(bcAdd, dialog->getLabel().toStdString(),
                    AddressBook::AddressBookPurpose::SEND)) {
