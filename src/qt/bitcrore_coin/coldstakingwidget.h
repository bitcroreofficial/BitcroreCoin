...
#include "qt/bitcrore_coin/furabstractlistitemdelegate.h"
#include "qt/bitcrore_coin/txviewholder.h"
#include "qt/bitcrore_coin/tooltipmenu.h"
#include "qt/bitcrore_coin/sendmultirow.h"
#include "qt/bitcrore_coin/coldstakingmodel.h"
...
public:
    explicit ColdStakingWidget(Bitcrore_CoinGUI* parent);
    ~ColdStakingWidget();
