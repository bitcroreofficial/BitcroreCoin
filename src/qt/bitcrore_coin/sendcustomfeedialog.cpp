...
#include "qt/bitcrore_coin/sendcustomfeedialog.h"
#include "qt/bitcrore_coin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(Bitcrore_CoinGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &Bitcrore_CoinGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
