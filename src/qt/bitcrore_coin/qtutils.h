...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, Bitcrore_CoinGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, Bitcrore_CoinGUI* gui, double posX = 3);
