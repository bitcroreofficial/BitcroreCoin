...
#include "qt/bitcrore_coin/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/bitcrore_coin/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(Bitcrore_CoinGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableBC,
    ...
    connect(ui->pushButton_UnspendableBC, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableBC);});
    ...
    if (parent)
        connect(parent, &Bitcrore_CoinGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
