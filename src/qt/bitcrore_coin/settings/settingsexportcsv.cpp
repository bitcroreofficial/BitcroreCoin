...
#include "qt/bitcrore_coin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(Bitcrore_CoinGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("Bitcrore_Coin_tx_csv_export(*.csv)") : tr("Bitcrore_Coin_addresses_csv_export(*.csv)"),
                                        nullptr);
