...
#include "qt/bitcrore_coin/settings/settingsnetworkwidget.h"
#include "qt/bitcrore_coin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/bitcrore_coin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(Bitcrore_CoinGUI* _window, QWidget *parent) :
