...
#include "qt/bitcrore_coin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(Bitcrore_CoinGUI* _window, QWidget *parent) :
