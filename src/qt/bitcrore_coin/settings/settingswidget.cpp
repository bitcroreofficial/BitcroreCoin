...
#include "qt/bitcrore_coin/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(Bitcrore_CoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &Bitcrore_CoinGUI::openFAQ);
