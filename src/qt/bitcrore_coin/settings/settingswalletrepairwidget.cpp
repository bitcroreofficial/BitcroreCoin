...
#include "qt/bitcrore_coin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/bitcrore_coin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(Bitcrore_CoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to Bitcrore_CoinGUI::handleRestart()
