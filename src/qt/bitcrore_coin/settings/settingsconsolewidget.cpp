...
#include "qt/bitcrore_coin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/bitcrore_coin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(Bitcrore_CoinGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Bitcrore Coin RPC console.") + "<br>" +
