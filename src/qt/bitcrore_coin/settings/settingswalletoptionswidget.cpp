...
#include "qt/bitcrore_coin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/bitcrore_coin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(Bitcrore_CoinGUI* _window, QWidget *parent) :
