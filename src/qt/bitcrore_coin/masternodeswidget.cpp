...
#include "qt/bitcrore_coin/forms/ui_masternodeswidget.h"

#include "qt/bitcrore_coin/qtutils.h"
#include "qt/bitcrore_coin/mnrow.h"
#include "qt/bitcrore_coin/mninfodialog.h"
#include "qt/bitcrore_coin/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(Bitcrore_CoinGUI *parent) :
    PWidget(parent),
    ...
    if (fs::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:1672 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
