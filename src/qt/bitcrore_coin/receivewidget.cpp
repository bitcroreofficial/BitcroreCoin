...
#include "qt/bitcrore_coin/forms/ui_receivewidget.h"
...
#include "qt/bitcrore_coin/addressholder.h"
...
ReceiveWidget::ReceiveWidget(Bitcrore_CoinGUI* parent) :
    PWidget(parent),
