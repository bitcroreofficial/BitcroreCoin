...
#include "qt/bitcrore_coin/forms/ui_topbar.h"
#include "qt/bitcrore_coin/lockunlock.h"
#include "qt/bitcrore_coin/qtutils.h"
#include "qt/bitcrore_coin/receivedialog.h"
#include "qt/bitcrore_coin/loadingdialog.h"
...
TopBar::TopBar(Bitcrore_CoinGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountBc}, "amount-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("Bitcrore Coin")
    updateDisplayUnit();
                            ...
                            const CAmount& delegatedBalance, const CAmount& coldStakedBalance)
{
    ...
    // BC Total
    QString totalBc = GUIUtil::formatBalance(balance, nDisplayUnit);

    // BC
    // Top
    ui->labelAmountTopBc->setText(totalBc);
    // Expanded
    ui->labelAmountBc->setText(totalBc);
    ui->labelPendingBc->setText(GUIUtil::formatBalance(unconfirmedBalance, nDisplayUnit));
    ui->labelImmatureBc->setText(GUIUtil::formatBalance(immatureBalance, nDisplayUnit));
}
