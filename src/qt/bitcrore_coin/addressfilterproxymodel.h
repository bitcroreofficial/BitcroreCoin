...
#ifndef Bitcrore_Coin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define Bitcrore_Coin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //Bitcrore_Coin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
