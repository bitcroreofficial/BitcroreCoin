...
#include <QWidget>
#include <QString>
#include "qt/bitcrore_coin/prunnable.h"
...
class PWidget : public QWidget, public Runnable, public Translator
{
    Q_OBJECT
public:
    explicit PWidget(Bitcrore_CoinGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    Bitcrore_CoinGUI* getWindow() { return this->window; }
...
protected:
    Bitcrore_CoinGUI* window = nullptr;
