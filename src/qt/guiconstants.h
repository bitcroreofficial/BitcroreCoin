...
/* Bitcrore_Coin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Bitcrore Coin"
#define QAPP_ORG_DOMAIN "bitcrore_coin.org"
#define QAPP_APP_NAME_DEFAULT "Bitcrore_Coin-Qt"
#define QAPP_APP_NAME_TESTNET "Bitcrore_Coin-Qt-testnet"
