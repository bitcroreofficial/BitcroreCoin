...
#ifndef Bitcrore_Coin_QT_WALLETMODEL_H
#define Bitcrore_Coin_QT_WALLETMODEL_H
...
/** Interface to Bitcrore_Coin wallet from Qt view code. */
...
#endif // Bitcrore_Coin_QT_WALLETMODEL_H
