...
This document provides guidelines for internationalization of the Bitcrore Coin software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        <source>%n active connection(s) to Bitcrore_Coin network</source>
        <translation>
            <numerusform>%n active connection to Bitcrore_Coin network</numerusform>
            <numerusform>%n active connections to Bitcrore_Coin network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcrore_coin_en.ts` remains unchanged.
