...
The build script we'll be using is contained in the Bitcrore_Coin github repository ([contrib/gitian-build.py](https://github.com/bitcrore_coin-project/bitcrore_coin/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the Bitcrore_Coin repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/Bitcrore_Coin-Project/Bitcrore_Coin/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, bitcrore_coin-detached-sigs, and bitcrore_coin GitHub repos.
