...
The script [extract-osx-sdk.sh](https://github.com/bitcrore_coin-project/bitcrore_coin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
bitcrore_coin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/bitcrore_coin-project/bitcrore_coin/blob/master/doc/README_osx.md) for troubleshooting tips.
