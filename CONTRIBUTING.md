Contributing to Bitcrore Coin
============================

The Bitcrore Coin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/bitcrore_coin-project/bitcrore_coin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Bitcrore Coin project, and is not to be
confused with overall Bitcrore_Coin Network Protocol consensus changes.

Whether a pull request is merged into Bitcrore Coin rests with the project merge
...
Patches that change Bitcrore_Coin consensus rules are considerably more involved than
...
Where a patchset proposes to change the Bitcrore_Coin consensus, it must have been
...
The project leader is the release manager for each Bitcrore Coin release.
