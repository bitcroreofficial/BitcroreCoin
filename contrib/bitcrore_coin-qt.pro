...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/bitcrore_coin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/bitcrore_coin-cli.cpp \
           src/bitcrore_coin-tx.cpp \
           src/bitcrore_coin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/bitcrore_coin.qrc src/qt/bitcrore_coin_locale.qrc

TRANSLATIONS += src/qt/locale/bitcrore_coin_bg.ts \
                src/qt/locale/bitcrore_coin_de.ts \
                src/qt/locale/bitcrore_coin_en.ts \
                src/qt/locale/bitcrore_coin_es.ts \
                src/qt/locale/bitcrore_coin_fi.ts \
                src/qt/locale/bitcrore_coin_fr.ts \
                src/qt/locale/bitcrore_coin_it.ts \
                src/qt/locale/bitcrore_coin_ja.ts \
                src/qt/locale/bitcrore_coin_pl.ts \
                src/qt/locale/bitcrore_coin_pt.ts \
                src/qt/locale/bitcrore_coin_ru.ts \
                src/qt/locale/bitcrore_coin_sk.ts \
                src/qt/locale/bitcrore_coin_sv.ts \
                src/qt/locale/bitcrore_coin_vi.ts \
                src/qt/locale/bitcrore_coin_zh_CN.ts \
                src/qt/locale/bitcrore_coin_zh_TW.ts
